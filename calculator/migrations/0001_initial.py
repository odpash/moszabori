# Generated by Django 3.2.9 on 2022-06-08 08:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': '[Metal] Лаги',
            },
        ),
        migrations.CreateModel(
            name='Metalpokraska',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tolshina', models.CharField(max_length=100, verbose_name='Толщина столба')),
                ('price', models.DecimalField(decimal_places=2, max_digits=100, verbose_name='Цена конфигурации')),
            ],
            options={
                'verbose_name': '[Navesi] Цена балки',
                'verbose_name_plural': '[Navesi] Цена балки',
            },
        ),
        migrations.CreateModel(
            name='Navesibokferma',
            ...
            options={
                ...
                'verbose_name_plural': '[Navesi] Боковая ферма',
            },
        ),
        migrations.CreateModel(
            name='Navesidlinastolbov',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('visota', models.DecimalField(decimal_places=2, max_digits=100, verbose_name='Высота столба')),
                ('tolshina', models.CharField(max_length=100, verbose_name='Толщина столба')),
            ...
            options={
                ...
                'verbose_name_plural': '[Navesi] Цена столбов',
            },
        ),
        migrations.CreateModel(
            name='Navesifermi',
            ...
            options={
                ...
                'verbose_name_plural': '[Navesi] Цена ферм',
            },
        ),
        migrations.CreateModel(
            name='Navesikonek',
            ...
            options={
                ...
                'verbose_name_plural': '[Navesi] Конек',
            },
        ),
        migrations.CreateModel(
            name='Navesikraska',
            ...
            options={
                ...
                'verbose_name_plural': '[Navesi] Краска',
            },
        ),
        migrations.CreateModel(
            name='Navesikrov',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': '[Navesi] Обрешетка ферм',
            },
        ),
        migrations.CreateModel(
            name='Navesiveter',
            ...
            options={
                ...
                'verbose_name_plural': '[Navesi] Ветровая планка',
            },
        ),
        migrations.CreateModel(
            name='Navesiystanovka',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='Введите название')),
                ('price', models.DecimalField(decimal_places=2, max_digits=100, verbose_name='Цена конфигурации')),
            ...
            options={
                ...
                'verbose_name_plural': '[Navesi] Установка',
            },
        ),
        migrations.CreateModel(
